...
val heap_set_env_val_addr_at_pos : t -> env_addr:int -> frame_index:int -> val_index:int -> val_addr:int -> unit
val heap_get_env_val_addr_at_pos : t -> env_addr:int -> frame_index:int -> val_index:int -> int
