...
export class SimpleLangLexer extends antlr.Lexer {
    ...
    get literalNames() { return SimpleLangLexer.literalNames; }
    get symbolicNames() { return SimpleLangLexer.symbolicNames; }
    get ruleNames() { return SimpleLangLexer.ruleNames; }
    get serializedATN() { return SimpleLangLexer._serializedATN; }
    get channelNames() { return SimpleLangLexer.channelNames; }
    get modeNames() { return SimpleLangLexer.modeNames; }
    ...
    static vocabulary = new antlr.Vocabulary(SimpleLangLexer.literalNames, SimpleLangLexer.symbolicNames, []);
    get vocabulary() {
        return SimpleLangLexer.vocabulary;
    }
    static decisionsToDFA = SimpleLangLexer._ATN.decisionToState.map((ds, index) => new antlr.DFA(ds, index));
}
//# sourceMappingURL=SimpleLangLexer.js.map